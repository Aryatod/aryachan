...
//===> UBAH DISINI
global.namaowner = 'Arya?' //Ganti Jadi Namamu
global.owner = ['6288215743467','6283143509630'] //Kalo Mau Lebih Tambahin Aja
global.nomerowner = '6288215743467' //Owner Utama Istilahnya
global.namabot = 'Perwira' //Ganti Jadi Nama Botmu
global.packname = 'PUNYA NYA ARYA BANH!!!!😾🖕' //Sticker Weem
global.author = 'Perwira' //Sticker Weem
global.webme = 'https://api-ryubotz.herokuapp.com' //Ganti Sama Web Mu
global.linkgroup = 'https://chat.whatsapp.com/DliVSAxR8vz4G5eYXxZYSU' //Ganti Sama Link Gc Mu
...
global.mess = {
admin: '*LU ADMIN NGGAK SU!!? 🤨*',
botAdmin: '*BOT BUKAN ADMIN NGENTOT!!😔*',
owner: '*LU BUKAN OWNER GW ASW!😠*',
group: '*KHUSUS GROUP 😏*',
private: '*KHUSUS PRIVATE CHAT*',
bot: '*KHUSUS PENGGUNA NOMER BOT*',
wait: '*SABAR SEDANG DI NGENTOT!!...*',
done: '*DONE BANH KATAKAN ARYA WANGSAF 🤗*',
}
